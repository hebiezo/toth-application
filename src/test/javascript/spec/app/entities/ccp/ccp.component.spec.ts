...
import { CCPComponent } from 'app/entities/ccp/ccp.component';
import { CCPService } from 'app/entities/ccp/ccp.service';
import { CCP } from 'app/shared/model/ccp.model';

describe('Component Tests', () => {
  describe('CCP Management Component', () => {
    let comp: CCPComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cCPS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
